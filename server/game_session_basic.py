...
class GameSessionBasic:
    ...
    def action(self,action_type,action_data):
        ...
        if action_type == "get_cards":
            ...
            next_title = self.action_ignore()
            return {"next_title": next_title}
        elif action_type == "action_post":
            next_title = self.action_post()
            return {"next_title": next_title}
    ...
    def next_title(self):
        ...
        new_title = self.ll_model.get_response(prompt,self.prompts['g0_main_instructions'][self.lang])
    ...
    def apply_cards(self,selected_card_ids):
        ...
        title = self.ll_model.get_response(tt,self.prompts['g0_main_instructions'][self.lang])
        title = title.strip('"')
    ...
    def compute_consequence(self):
        ...
        consequence = self.ll_model.get_response(prompt,self.prompts['g0_main_instructions'][self.lang])
